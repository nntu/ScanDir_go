...
.PHONY: all build-image create-container copy-scanner copy-deleter remove-container extract-binaries clean
...
extract-binaries: create-container copy-scanner copy-deleter remove-container
